...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    // http://localhost:8189/app/ws/categories.wsdl
    ...
    public DefaultWsdl11Definition groupsWsdl11Definition(XsdSchema categoriesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.lazarev.ru/spring/ws/categories");
    ...
    public DefaultWsdl11Definition studentsWsdl11Definition(XsdSchema productsSchema) {
        ...
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://www.lazarev.ru/spring/ws/products");
    ...
    public XsdSchema categoriesSchema() {
        return new SimpleXsdSchema(new ClassPathResource("ws/categories.xsd"));
    }
